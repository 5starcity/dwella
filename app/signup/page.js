  ...
  return (
    <div className="auth-modal-overlay">
      ...
      >
        ...
        <p>Welcome, {user.displayName?.split(" ")[0] || "there"}! Are you a student or a landlord?</p>
...
export default function SignupPage() {
  ...
  return (
    <>
      {pendingUser && <RolePickerModal user={pendingUser} onDone={handleRoleDone} />}
      ...
      <div className="auth-page">
        ...
        >
          ...
          <button className="auth-email-toggle" onClick={() => setShowEmail((v) => !v)}>
            <HiOutlineEnvelope />
            Sign up with email
            <HiOutlineChevronDown className={"auth-email-toggle__chevron" + (showEmail ? " open" : "")} />
          </button>
              ...
              >
                ...
                <div className="auth-field">
                  ...
                  <div className="auth-role-toggle">
                    ...
                    <button type="button" className={"role-btn" + (form.role === "landlord" ? " active" : "")} onClick={() => setForm({ ...form, role: "landlord" })}>
                      🏠 Landlord
                    </button>
                  </div>
                </div>
